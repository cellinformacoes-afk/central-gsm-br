  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-4">
      ...
      <div className="flex gap-4 mb-10 border-b border-[#334155] pb-4 overflow-x-auto no-scrollbar">
         ...
         <Link href="/admin/estoque" className="text-[#00D2AD] border-b-2 border-[#00D2AD] font-black uppercase text-xs tracking-widest px-4 py-2 whitespace-nowrap">📦 Gestão de Estoque</Link>
