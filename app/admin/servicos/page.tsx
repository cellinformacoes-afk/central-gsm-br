                 ...
                 {![5, 6].includes(formCategoryId || 0) && (
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center bg-[#0f172a] p-6 rounded-3xl border border-[#334155]">
                      ...
                      <div className="space-y-2">
                         ...
                         <input name="duration_hours" type="number" step="any" min="0" defaultValue={editingService?.duration_hours} className="w-full bg-[#1e293b] border border-[#334155] rounded-xl p-3 text-white outline-none focus:border-[#00D2AD]" />
