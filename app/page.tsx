    ...
    <>
            ...
            >
              ...
              <div className="flex-1 min-w-0 relative z-10">
                 ...
                 <div className="flex items-center gap-4">
                    ...
                    {service.category_id !== 9 && service.time_estimate && (
      ...
      <div className="mt-20 p-12 bg-gradient-to-r from-[#1e293b] to-[#0f172a] rounded-[50px] border border-[#00D2AD]/20 flex flex-col lg:flex-row items-center justify-between gap-10 shadow-3xl">
         ...
         <div className="flex flex-col sm:flex-row gap-4">
            <a href="https://wa.me/5511966959666?text=Vim%20pelo%20site%20Centralgsm" className="whitespace-nowrap bg-[#25D366] hover:bg-[#1fb356] text-white px-8 py-5 rounded-[30px] font-black uppercase text-base shadow-[0_15px_35px_rgba(37,211,102,0.3)] hover:-translate-y-2 transition-all flex items-center justify-center gap-2">
