...
export default function DownloadsPage() {
  ...
  const tools = [
    { name: 'SamFw Tool v4.9', desc: 'Ferramenta completa para Samsung FRP e muito mais.', size: '15 MB', url: '#' },
    { name: 'SP Flash Tool', desc: 'Software oficial da MediaTek para Flashear ROMs.', size: '45 MB', url: '#' },
    { name: 'Odin v3.14.4', desc: 'Flasheador de ROM nativo para toda linha Samsung.', size: '3.5 MB', url: '#' },
    { name: 'Motorola Fastboot Fix', desc: 'Script automatizado para remover MDM da linha Moto.', size: '1 MB', url: '#' },
    { name: 'Pacote de Drivers Universal', desc: 'Drivers ADB, Fastboot, Samsung, MTK e SPD em um clique.', size: '250 MB', url: '#' },
    { name: 'UnlockTool setup mais recente', desc: 'Instalador online oficial 2026.', size: '120 MB', url: '#' },
  ];
