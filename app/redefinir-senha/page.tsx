    ...
    <div className="min-h-screen w-full flex bg-[#09090b] text-white">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-[#09090b]">
        <div className="w-full max-w-md space-y-8">
          ...
          {noCode && (
            <div className="p-4 bg-yellow-500/10 border border-yellow-500/30 text-yellow-400 text-sm rounded-xl font-bold flex items-center gap-2">
              <span className="text-lg">⚠️</span> Link de recuperação inválido. Solicite um novo link de recuperação de senha.
            </div>
          )}
          ...
          <form onSubmit={handleUpdatePassword} className="space-y-6">
            ...
            <button
              disabled={loading || success || noCode}
