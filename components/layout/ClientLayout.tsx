  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0f172a]">
      ...
      <div className="fixed right-4 bottom-4 z-40">
        <a href="https://wa.me/5511966959666?text=Vim%20pelo%20site%20Centralgsm" target="_blank" className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform">
