...
// Chave PIX: CNPJ sem formatação (só os 14 números) conforme exige a API da Efí
const EFI_PIX_KEY_RAW = process.env.EFI_PIX_KEY || '68634882000180';
// Remove qualquer formatação caso venha com pontos, barras, traços
const EFI_PIX_KEY = EFI_PIX_KEY_RAW.replace(/[.\-\/]/g, '');
