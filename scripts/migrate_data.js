const data = [
  ...
  },
  {
    ...
    steps: [
      { title: "Passo 1", description: "DESATIVE A SEHURANÇA DO WINDOWS", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.8729685713456429.jpeg" },
      { title: "", description: "DESATIVE O WINDOWS DEFEDENDER", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.29650114208779166.jpeg" },
      { title: "", description: "DESLIGUE O CELULAR DEIXE ELE DESLIGADO E FORA DO CABO USB" },
      { title: "", description: "ABRAO SERVIDOR PHOENIX NO SEU PC E FAÇA O LOGIN ", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.12909838341838697.jpeg" },
      { title: "", description: "OBS: PARA FAZER A LEITURA DAS PARTIÇOES PARA FAZER O DESBLOQUEIO VOCÊ DEVE COLOCAR CREDITOS NO SUA CONTA DA PHOENIX NA DATA DE HOJE 19/05/2026 CONSOME 2 CREDITOS PARA FAZER A LEITURA, OS CREDITOS VOCÊ PODE ADQUIRIR AQUI NO NOSSO SITE CENTRALGSM OU EM QUALQUER OUTRO FORNECEDOR ( ENTENDIDO DISSO VAMOS PROSSEGUIR", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.22126572090484076.png" },
      { title: "", description: "COM O PROGRAMA ABERTO VAI NA ABA ( OPLUS ) CLIQUE NA ABA ( PARTICION MANEGE ) E SELECIONE O SEU MODELO ( EXEPLO - REALME C75X RMX 5020 )", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.2876683861184577.jpeg" },
      { title: "", description: "AGORA CLIQUE EM ( LOAD ) PARA COMESSAR A LEITURA DAS PARTIÇOES ", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.7101581874209302.jpeg" },
      { title: "", description: "VAI APARECER QUE CONSOME 2 CREDITOS, CONFIRME CLIANDO EM ( OK )", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.013711023094058361.jpeg" },
      { title: "", description: "APÓS CONFIRMAR O OK NO AVISO DO CONSUMO DO CREDITO VAI APARECER ( Searching for device... ) ISSO SIGNIFICA QUE O PROGRAMA ESTÁ AGUARDANDO VOCÊ FAZER A CONEXÃO DO CELL, IGUAL NO PROXIMO PASSO", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.6473076297748948.jpeg" },
      { title: "", description: "PARA FAZER A CONEXÃO - SEGURE OS 2 BOTÕES DE VOLUME E CONECTE O CABO USB NO CELULAR ( SÓ VAI SOLTAR OS BOTÕES QUANDO O PROGRAMA COMESSAR A FAZER A LEITURA DO CELULAR ) ", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.825814867053509.png" },
      { title: "", description: "APÓS FAZER A CONEXÃO DA FORMA CORRETA IRA COMESSAR A LEITURA DO CELULAR E NA SEQUENCIA JA VAI ABRIR AS PARTICOES DO CELULAR  ", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.4555903267732605.jpeg" },
      { title: "", description: "AO ABRIR AS PARTIÇOES, VAI ESTÁ TODAS AS PARTIÇOES MARCADO, (DESARQUE TODAS DEIXE SOMENTE AS OPÇÕES (  OPLUSRESERV 1 - OPLUSRESERV 2 - OPLUSRESERV 3 - OPLUSRESERV 5 - OPLUSRESERV 6 - FRP - PROINFO ) VAI DEIXAR MARCADO SOMETE ESSAS 06 OPÇÕES MARCADAS )", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.6674421921538245.jpeg" },
      { title: "", description: "APÓS MARCAR AS 06 PARTIÇOES CLIQUE EM ( READ ) PARA FAZER O BACKUP DAS PARTIÇOES ANTES DE DAR O ERASE ( ISSO É MUITO INPORTANTE FAZER BACKUP DAS PARTIÇOÕES QUE VAMOS TRABALHAR )........................... APÓS CLICAR EM READ VAI APARECER A ABA DO EXPLORE PARA VOCÊ SELECIONAR A PASTA QUE VOCÊ QUER SALVAR O BACKUP APÓS CLICAR NA PASTA QUE QUER GUARDAR O BACKUP ( CLIQUE SELECIONAR PASTA ) FEITO ISSO VAI COMESSAR A FAZER O BACKUP DAS 06 PARTIÇOÕES ", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.28849347127359615.jpeg" },
      { title: "", description: "ANTES DE IR PARA O PROXIMO PASSO CONFIRME SE O SEU FEZ O BACKUP CORRETAMENTE SE DEU CERTO VAI APARECER IGUAL A IMAGEM DESSE PASSO ", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.16704346654393754.jpeg" },
      { title: "", description: "APÓS APARECER OK EM TODAS PARTIÇOES INFORMANDO QUE FOI FEITO O BACKUP IGUAL A IMAGEM DO PASSO ANTERIOR................... AGORA VOCÊS VÃO CLICAR EM ( ERASE ) IGUAL A IMAGEM DESSE PASSO A PASSO", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.7583978453363704.jpeg" },
      { title: "", description: "APÓS CLICAR EM ERASE CONFIRME, IGUAL A IMAGEM QUE FOI FEITO ERASE SOMETE NAS 06 PATIÇOES QUE ESTAVA SELECIONA AS MESMA QUE NÓS FIZEMOS O BACKP ( CONFIRME SE O ERASE DAS PARTIÇOES DEU CERTO IGUAL A ESSA IMAGEM ", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.6614455477352618.jpeg" },
      { title: "", description: "TUDO FEITO. AGORA CLIQUE EM ( REBOOT ) PARA O CELULAR COMESSAR A LIGAR", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.04610623809201542.jpeg" },
      { title: "", description: "AGUARDE ELE TERMINAR DE LIGAR E FAÇA AS CONFIGURAÇÕES INICIAL POIS O MESMO JA FOI DESBLOQUEADO COM SUCESSO ( PAYJOY ) REMOVIDA DEFINITIVAMENTE ", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.097183160993215.jpeg" },
      { title: "", description: "DONE ", image_url: "https://cvzhczgvfvflmcwmmvlh.supabase.co/storage/v1/object/public/tutorials/steps/0.3414424439730892.png" }
    ],
    attention: "TESTADO - até pat de 1 DE JANEIRO DE 2026 (  android 15 ) BATERIA - faça com o celular acima de 30% de carga CABO - preferencia original ou similar de boa qualidade PROGRAMAS UTILIZADO - PHOENIX SERVICE TOOL OBS: você deve ter os drive MTK instalado no seu pc "
  },
  {
